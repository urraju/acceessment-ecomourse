          ...
          <div className="flex items-center gap-20">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <p className="w-9 h-9 rounded-md flex items-center justify-center bg-orange-500 text-white">
                  14
                </p>
                :
                <p className="w-9 h-9 rounded-md p-1 text-lg   flex items-center justify-center bg-orange-500 text-white">
                  28
                </p>
                :
                <p className="w-9 h-9 rounded-md flex items-center justify-center text-lg   bg-orange-500 text-white">
                  25
                </p>
              </div>
            </div>
